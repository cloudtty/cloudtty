...
| image.tag | string | v0.5.4 | Cloudtty image tag (immutable tags are recommended) |
...
| jobTemplate.image.tag | string | v0.5.4 | Cloudtty Job image tag (immutable tags are recommended) |
