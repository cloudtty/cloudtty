...
| image.tag | string | v0.6.3 | Cloudtty image tag (immutable tags are recommended) |
...
| jobTemplate.image.tag | string | v0.6.0 | Cloudtty Job image tag (immutable tags are recommended) |
