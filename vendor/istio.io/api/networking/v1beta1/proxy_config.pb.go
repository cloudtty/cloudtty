...
func file_networking_v1beta1_proxy_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_networking_v1beta1_proxy_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_networking_v1beta1_proxy_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
