...
type SignerClient interface {
	...
	PublicKey(ctx context.Context, in *PublicKeyRequest, opts ...grpc.CallOption) (*PublicKeyReply, error)
}
...
func (c *signerClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignReply, error) {
	out := new(SignReply)
	err := c.cc.Invoke(ctx, "/grpcsigner.Signer/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signerClient) PublicKey(ctx context.Context, in *PublicKeyRequest, opts ...grpc.CallOption) (*PublicKeyReply, error) {
	out := new(PublicKeyReply)
	err := c.cc.Invoke(ctx, "/grpcsigner.Signer/PublicKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignerServer interface {
	...
	PublicKey(context.Context, *PublicKeyRequest) (*PublicKeyReply, error)
...
func (UnimplementedSignerServer) Sign(context.Context, *SignRequest) (*SignReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sign not implemented")
}
func (UnimplementedSignerServer) PublicKey(context.Context, *PublicKeyRequest) (*PublicKeyReply, error) {
...
func _Signer_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcsigner.Signer/Sign",
	}
...
func _Signer_PublicKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcsigner.Signer/PublicKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
